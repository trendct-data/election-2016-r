---
title: "2016 CT election analysis IV"
author: "Andrew Ba Tran"
date: "November 9, 2016"
output: html_document
---

This is exploratory data visualization used to write the story [What the 2016 presidential election returns reveal about Connecticut voters](http://trendct.org/2016/11/15/what-the-2016-presidential-election-results-say-about-connecticut/)

**Correlations between diff in 2016 and 2016 votes and selected Census and [DataHaven](http://www.ctdatahaven.org/reports/datahaven-community-wellbeing-survey) data points.**

Visit [the repo](https://github.com/trendct-data/election-2016-r) for this story for more walkthroughs, data, and scripts used in the analysis.
...
gg <- gg + labs(x=NULL, y=NULL, 
                ...
                subtitle="Trump got the rural voters in Connecticut while voters in urban cities supported Clinton",
...
for (i in 1:nrow(wellness_columns)) {
  ...
  gg <- gg + labs(x=column_title, y="Difference in support 2016 and 2012", 
...
gg <- ggplot()
  ...
  gg <- gg + labs(x="Percent residents who consider town declining", y="Percent of votes", 
                  title="Votes compared to whether residents think town is not improving",
                  subtitle="Size of circles are relative to town population.",
                  caption="Source: Office of the Secretary of the State, U.S. Census\n Andrew Ba Tran/TrendCT.org")
  gg <- gg + theme_bw(base_family="Lato Regular")
  gg <- gg + theme(axis.ticks.y=element_blank())
...
gg <- ggplot()
  ...
  gg <- gg + labs(x="Percent of residents who feel they have no influence on local government", y="Difference in support 2016 and 2012", 
                  title="Votes compared to disenfranchised citizens ",
                  subtitle="Votes and whether residents feel they have no influence on local government.\nSize of circles are relative to town population.",
