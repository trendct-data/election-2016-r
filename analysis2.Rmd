...
col_names_clean <- c("Rate of adults satisfied with area", "Percent of adults who feel safe to walk area at night", "Food insecurity rate", "Housing insecurity rate", "Transportation insecurity rate", "Adults without a bank ccount", "Underemployed adults", "White population", "Foreign born population", "Home ownership rate", "Household costs burdened", "Adults over 25 without a High School diploma",
...
for (i in 1:nrow(wellness_columns)) {
  ...
  cat("Trump correlation rate: ", cor(trump_per3$percent, trump_per3$Percent_White, use="complete.obs"))
